    ...
    <section class="fdb-block">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div
            class="col-8 col-sm-6 col-md-2 col-lg-3 col-xl-2 mt-4 mt-md-0 ml-auto mr-auto mr-md-0"
          >
            <img
              alt="image"
    ...
    <section class="fdb-block">
      <div class="container">
        <div class="row text-center">
          <div class="col-12">
            <h3>
              <strong>You are in good company</strong>
            </h3>
            ...
            <div class="mt-2 mt-md-5 justify-content-center">
              <img
                ...
                height="30"
                class="ml-3 mr-3 mb-2 mt-2"
                src="imgs/customers/cisco.svg"
              />
              <img
                alt="image"
                height="30"
                class="ml-3 mr-3 mb-2 mt-2"
                src="imgs/customers/apple.svg"
              />
              <img
                alt="image"
                height="30"
                class="ml-3 mr-3 mb-2 mt-2"
                src="imgs/customers/ibm.svg"
              />
              <img
                alt="image"
                height="30"
                class="ml-3 mr-3 mb-2 mt-2"
                src="imgs/customers/intel.svg"
              />
              <img
                alt="image"
                height="30"
                class="ml-3 mr-3 mb-2 mt-2"
                src="imgs/customers/panasonic.svg"
              />
            </div>
          </div>
        </div>
            ...
            <div class="fdb-box">
              <div class="row">
                ...
                <div class="col-md-8 mt-4 mt-md-0">
                  <p class="lead">
                    "Even the all-powerful Pointing has no control about day
              ...
              <div class="row">
                ...
                <div class="col-md-8 mt-4 mt-md-0">
                  <p class="lead">
                    ...
                    countries Vokalia and Consonantia. Separated they at the
    ...
    <section class="fdb-block">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center">
          ...
          <div
            class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center"
          >
      ...
      <div class="container">
        <div class="row text-center justify-content-center">
          <div class="col-md-10 col-lg-8 col-xl-7">
            ...
            <p class="lead">
              A small river named Duden flows by their place and supplies it
              with the necessary regelialia. Separated they live in
              ...
              <div class="row mt-4">
                <div class="col-12">
                  <p class="lead">
                    ...
                    blind texts it is an small line of blind text by the name of
            ...
            <div class="fdb-box">
              ...
              <div class="row mt-4">
                <div class="col-12">
                  <p class="lead">
                    "Far far away, behind the word mountains, far from the
                    countries Vokalia. Separated they live in Bookmarksgrove
              ...
              <div class="row mt-4">
                <div class="col-12">
                  <p class="lead">
                    ...
                    the Semantics, the word mountains, far from the countries
                    Vokalia and Consonantia, there live the blind texts."
                  </p>
                </div>
              </div>
    ...
    <section class="fdb-block">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center">
          ...
          <div
            class="col-md-10 col-lg-3 pt-5 pt-lg-0 ml-auto mr-auto text-center"
          >
            <p class="h3 mb-4 mb-lg-5">
              "Separated they live in Bookmarksgrove right at the coast of the
              Semantics, a large language ocean."
