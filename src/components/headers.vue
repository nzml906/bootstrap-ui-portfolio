      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarNav5">
            ...
            <a class="btn btn-primary ml-md-3" href="https://www.froala.com"
              >Button</a
            >
          </div>
        </nav>
    ...
    <header>
      <div class="container">
        <nav class="navbar navbar-expand-md no-gutters">
          ...
          <div
            class="collapse navbar-collapse justify-content-end col-md-2 navbar-collapse-1"
          >
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="https://www.froala.com">
      ...
      <div class="container">
        <nav class="navbar navbar-expand-md">
          ...
          <div class="collapse navbar-collapse" id="navbarNav9">
            ...
            <a
              class="btn btn-outline-light ml-md-3"
              href="https://www.froala.com"
              >Button</a
            >
          </div>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarNav13">
            ...
            <a class="btn btn-light ml-md-3" href="https://www.froala.com"
              >Button</a
            >
          </div>
        </nav>
