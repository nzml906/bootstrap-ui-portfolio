  ...
  <div>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 text-center">
            ...
            <p class="mt-5 mt-sm-4">
              <a class="btn btn-primary" href="https://www.froala.com"
                >Download</a
              >
            </p>
          </div>
        ...
        <div class="row">
          <div class="col-12 text-center">
            ...
            <img
              ...
              height="30"
              class="ml-3 mr-3 mb-2 mt-2"
              src="imgs/customers/amazon.svg"
            />
            <img
              alt="image"
              height="30"
              class="ml-3 mr-3 mb-2 mt-2"
              src="imgs/customers/ebay.svg"
            />
            <img
              alt="image"
              height="30"
            ...
            <img
              ...
              height="30"
              class="ml-3 mr-3 mb-2 mt-2"
              src="imgs/customers/orange.svg"
            />
            <img
              alt="image"
              height="30"
              class="ml-3 mr-3 mb-2 mt-2"
              src="imgs/customers/salesforce.svg"
            />
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-10 col-md-8 col-lg-4 text-center">
            <p class="lead">Follow us and ask more on:</p>
            <p class="h2">
      ...
      <div class="container">
        ...
        <div class="row text-center pt-4 pt-md-5">
          <div class="col-12 col-sm-10 col-md-6 col-lg-4 m-sm-auto">
            ...
            <p class="mt-3">
              <a class="btn btn-light sl-1" href="https://www.froala.com"
                >Button</a
              >
            </p>
          </div>
          ...
          <div
            class="col-12 col-sm-10 col-md-6 col-lg-4 ml-sm-auto mr-sm-auto mt-5 mt-md-0"
          >
    ...
    <section class="fdb-block py-0">
      <div
        ...
        style="background-image: url(imgs/shapes/4.svg);"
      >
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-auto text-center">
            <a class="btn btn-outline-secondary" href="https://www.froala.com"
              >Download</a
            >
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            ...
            <p class="h2">Far far away, behind the word mountains, far from.</p>
          </div>
        </div>
    ...
    <section class="fdb-block py-0">
      <div
        class="container bg-r py-5 my-5"
        style="background-image: url(imgs/shapes/1.svg);"
      >
        <div class="row py-5">
    ...
    <section
      ...
      style="background-image: url(imgs/hero/blue.svg);"
    >
      <div class="container align-items-center justify-content-center d-flex">
        <div class="row justify-content-center text-center">
          <div class="col-12 col-md-10 col-lg-8">
            ...
            <p class="mt-5">
              <a href="https://www.froala.com" class="btn btn-outline-light"
                >Call to Action</a
              >
            </p>
          </div>
      ...
      <div class="container align-items-end justify-content-center d-flex">
        <div class="row align-items-top text-left">
          <div class="col-12 col-md-6 col-lg-5">
            <p class="mb-5 mt-5">
              <img alt="image" height="40" src="imgs/logo.png" />
            </p>
            <h1>Design Blocks</h1>
            <p class="lead">
              Far far away, behind the word mountains, far from the countries
          ...
          <div class="col-12 col-sm-10 col-md-8 col-lg-8">
            ...
            <p class="mt-5">
              <a href="https://www.froala.com" class="btn btn-light"
                >Call to Action</a
              >
              <a href="https://www.froala.com" class="btn btn-dark ml-4"
                >Button</a
              >
            </p>
          </div>
