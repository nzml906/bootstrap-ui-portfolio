<template>
  <div>
    ...
    <section class="fdb-block">
      <div class="container">
        <div class="row text-left justify-content-sm-center">
          ...
          <div
            class="col-12 col-sm-6 col-lg-3 col-xl-2 ml-xl-auto mr-xl-auto pt-3 pt-md-0 pt-lg-0"
          >
            <h3><strong>Feature 2</strong></h3>
            <p>
              Separated they live in Bookmarksgrove right at the coast of the.
          ...
          <div
            class="col-12 col-sm-6 col-lg-3 col-xl-2 ml-xl-auto mr-xl-auto pt-3 pt-lg-0"
          >
            <h3><strong>Feature 3</strong></h3>
            <p>
              A small river named Duden flows by their place and supplies it
    ...
    <!-- Feature 4 -->
    <section
      class="fdb-block bg-dark"
      style="background-image: url(imgs/hero/purple.svg);"
    >
      <div class="container">
        <div class="row">
        ...
        <div class="row text-center justify-content-sm-center no-gutters">
          ...
          <div
            class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-3 m-auto pt-5 pt-xl-0"
          >
            <div class="fdb-box fdb-touch">
              <h2>Feature 2</h2>
              <p>
    ...
    <section class="fdb-block">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div
            class="col-12 col-md-8 col-lg-6 m-auto mr-lg-0 ml-lg-auto pt-5 pt-lg-0"
          >
      ...
      <div class="container">
        ...
        <div class="row text-center justify-content-center mt-5">
          ...
          <div class="col-12 col-sm-6 col-lg-3 pt-4 pt-lg-0">
            ...
            <h3><strong>Feature Four</strong></h3>
            <p>
              Duden flows by their place far far away, behind the word
              mountains.
            </p>
          </div>
        </div>
    ...
    <section class="fdb-block">
      <div class="container">
        <div class="row text-lg-right align-items-center">
          ...
          <div
            class="col-12 col-sm-6 col-lg-3 text-left pt-3 pt-sm-0 order-lg-12"
          >
            <img alt="image" class="fdb-icon" src="imgs/icons/map-pin.svg" />
            <h4><strong>Feature Four</strong></h4>
          ...
          <div class="col-7 col-sm-4 col-lg-4 m-auto pt-5 pt-lg-0 order-lg-1">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/draws/simple-iphone.svg"
            />
          </div>
        </div>
      </div>
            ...
            <div class="row pt-5">
              <div class="col-9 text-right">
                <p>
                  ...
                  Bookmarksgrove, there live the blind texts.
                </p>
              </div>
    ...
    <section class="fdb-block">
      <div class="container">
        ...
        <div class="row text-right align-items-center-lg align-items-end pt-5">
          ...
          <div
            class="col-12 col-md-7 col-lg-6 col-xl-5 m-auto text-left pt-5 pt-md-0"
          >
            <h3><strong>Feature One</strong></h3>
            <p>
              A small river named Duden flows by their place and supplies it
        ...
        <div class="row mt-5 justify-content-center">
          <div class="col-8">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/draws/product-tour.svg"
            />
          </div>
        </div>
      </div>
    ...
    <section class="fdb-block">
      <div class="container">
        ...
        <div class="row text-left mt-5">
          <div
            class="col-12 col-sm-8 col-md-4 col-lg-3 m-sm-auto mr-md-auto ml-md-0"
          >
            <img
              alt="image"
              class="img-fluid rounded"
              src="imgs/hero/blue.svg"
            />
            <h3><strong>Feature One</strong></h3>
            <p>
          ...
          <div
            class="col-12 col-sm-8 col-md-4 col-lg-3 m-sm-auto ml-md-auto mr-md-0 pt-5 pt-md-0"
          >
            <img
              alt="image"
              class="img-fluid rounded"
              src="imgs/hero/yellow.svg"
            />
            <h3><strong>Feature Three</strong></h3>
            <p>
              The Big Oxmox advised her not to do so, because there were
        ...
        <div class="row text-left pt-5">
          <div class="col-12 col-md-6">
            ...
            <p>
              ...
              necessary regelialia. When she reached the first hills of the
          ...
          <div class="col-12 col-md-6 pt-4 pt-md-0">
            ...
            <p>
              It is a paradisematic country, in which roasted parts of sentences
              fly into your mouth. Even the all-powerful Pointing has no control
              about the blind texts it is an almost unorthographic life. The Big
              Oxmox advised her not to do so, because there were thousands of
              bad Commas, wild Question Marks and devious Semikoli. On her way
        ...
        <div class="row justify-content-center">
          <div class="col-12 text-left">
            ...
            <p class="lead">
              ...
              Vokalia and Consonantia, there live the blind texts. Separated
              they live in Bookmarksgrove right at the coast of the Semantics, a
              large language ocean. On her way she met a copy. The copy warned
        ...
        <div class="row text-left align-items-center pt-5 pb-md-5">
          <div class="col-4 col-md-5 m-md-auto order-md-5">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/draws/design-life.svg"
            />
          </div>
        ...
        <div class="row text-left align-items-center pt-5">
          <div class="col-4 col-md-5">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/draws/design-community.svg"
            />
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-8 text-left">
            ...
            <p class="lead">
              <a href="https://www.froala.com"
                >Explore all features <i class="fas fa-angle-right"></i
              ></a>
            </p>
          </div>
        </div>
          ...
          <div class="col-12 col-md-6 pt-5 pt-md-0">
            <div class="row justify-content-left">
              ...
              <div class="col-3 m-auto text-center">
                ...
                <p>
                  <a href="https://www.froala.com"
                    >Two <i class="fas fa-angle-right"></i
                  ></a>
                </p>
              </div>
              <div class="col-3 m-auto text-center">
                ...
                <p>
                  <a href="https://www.froala.com"
                    >Three <i class="fas fa-angle-right"></i
                  ></a>
                </p>
              </div>
            </div>
            ...
            <div class="row justify-content-left mt-4 mt-xl-5">
              <div class="col-3 m-auto text-center">
                ...
                <p>
                  <a href="https://www.froala.com"
                    >Four <i class="fas fa-angle-right"></i
                  ></a>
                </p>
              </div>
              <div class="col-3 m-auto text-center">
                ...
                <p>
                  <a href="https://www.froala.com"
                    >Five <i class="fas fa-angle-right"></i
                  ></a>
                </p>
              </div>
            </div>
    ...
    <section class="fdb-block">
      <div class="container">
        <div class="row align-items-center pb-xl-5">
          ...
          <div
            class="col-12 col-sm-6 col-md-4 m-sm-auto mr-md-0 ml-md-auto pt-4 pt-md-0"
          >
        ...
        <div class="row justify-content-center pb-xl-5">
          <div class="col-8 col-sm-8 text-center">
            ...
            <img
              alt="image"
              class="img-fluid mt-5"
              src="imgs/draws/development.svg"
            />
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row text-center justify-content-center mt-5">
          ...
          <div class="col-12 col-md-4 col-lg-3 m-md-auto pt-3 pt-md-0">
            <h3><strong>Feature 2</strong></h3>
            <p>
              Separated they live in Bookmarksgrove right at the coast, a large
              language ocean.
            </p>
          </div>
        ...
        <div class="row justify-content-center text-center mt-5 mt-md-4 pt-5">
          <div class="col-12 col-md-10 col-lg-8">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/draws/social-media.svg"
            />
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <p class="mt-3">
              <a class="btn btn-primary" href="https://www.froala.com">Learn</a>
            </p>
          </div>
        ...
        <div class="row text-left">
          ...
          <div class="col-12 col-md-8 m-auto col-lg-4 pt-5 pt-lg-0">
            <div class="fdb-box fdb-touch">
              <h2>Feature 3</h2>
              <p>
                A small river named Duden flows by their small place and
      ...
      <div class="container">
        <div class="row text-left">
          <div class="col-12 col-md-4">
            <h2>Feature One</h2>
            <p>
              <strong>Far far away</strong>, behind the word mountains, far from
              the countries
              <a href="https://www.froala.com">Vokalia and Consonantia</a>,
              there live the blind texts.
            </p>
          </div>
          ...
          <div class="col-12 col-md-4 pt-5 pt-sm-4 pt-md-0">
            ...
            <p>
              ...
              <strong>blind texts</strong> it is an almost unorthographic life.
            </p>
          </div>
        </div>
      </div>
