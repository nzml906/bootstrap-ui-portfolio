      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 col-lg-6 text-center">
            ...
            <p class="h4">
              Find us on
              <a href="https://www.froala.com">Facebook</a> and
              <a href="https://www.froala.com">Twitter</a>.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="col-12 col-lg-10 col-xl-8 text-center">
            <div class="row">
              <div class="col">
                <h1>Register</h1>
                <p class="lead">
                  When she reached the first hills, she had a last view back on
        ...
        <div class="row">
          <div class="col-12 col-md-6 m-md-auto ml-lg-0 col-lg-5">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/draws/group-chat.svg"
            />
          </div>
          <div
            class="col-12 col-md-10 col-lg-6 mt-4 mt-lg-0 ml-auto mr-auto ml-lg-auto text-left"
          >
            <div class="row">
              <div class="col">
                <h1>Subscribe</h1>
