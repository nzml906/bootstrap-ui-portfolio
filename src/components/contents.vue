  ...
  <div>
        ...
        <div class="row justify-content-center">
          <div class="col col-md-8 text-center">
            <p class="lead">
              ...
              they live in
              <a href="https://www.froala.com">Bookmarksgrove</a> right at the
        ...
        <div class="row justify-content-center">
          <div class="col col-md-8 text-center">
            ...
            <p class="lead">
              ...
              the far
              <a href="https://www.froala.com">World of Grammar</a>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col text-left">
            ...
            <p>
              Far far away, behind the word mountains, far from the countries
              <a href="https://www.froala.com">Vokalia</a> and
              <a href="https://www.froala.com">Consonantia</a>, there live the
            ...
            <p>
              ...
              word "and" and the
              <a href="https://www.froala.com">Little Blind Text</a> should turn
              around and return to its own, safe country. But nothing the copy
              said could convince her and so it didn’t take long until a few
              insidious Copy Writers ambushed her, made her drunk with Longe and
              Parole and dragged her into their agency, where they abused her
              for their.
            </p>
          </div>
        </div>
            ...
            <div class="row text-left pt-4">
              <div class="col-12 col-md-6">
                <p class="lead">
                  ...
                  Duden flows by their place far far away.
                </p>
              </div>
              <div class="col-12 col-md-6">
                <p class="lead">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-6 col-lg-5 ml-md-auto text-left">
            ...
            <p>
              <a class="btn btn-secondary mt-4" href="https://www.froala.com"
                >Download</a
              >
            </p>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 ml-auto col-md-6 col-lg-5">
            ...
            <p>
              <a
                class="btn btn-primary mt-4 mb-5 mb-md-0"
    ...
    <section class="fdb-block py-0">
      <div
        ...
        style="background-image: url(imgs/shapes/10.svg);"
      >
    ...
    <section class="fdb-block py-0">
      <div
        class="container py-5 my-5 bg-r"
        style="background-image: url(imgs/shapes/9.svg);"
      >
        <div class="row text-left py-5">
            ...
            <div class="fdb-box fdb-touch">
              <div class="row justify-content-center">
                <div class="col-12 col-xl-8 text-center">
                  ...
                  <p class="h3 mt-4">
                    <a href="https://www.froala.com" class="btn btn-primary"
                      >Register</a
                    >
                  </p>
                </div>
        ...
        <div class="row align-items-center">
          <div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pb-5 pb-md-0">
            <img
              alt="image"
              class="img-fluid rounded-0"
              src="imgs/draws/iphone-hand.svg"
            />
          </div>
          ...
          <div class="col-12 ml-md-auto col-md-7 col-lg-6 pb-5 pb-md-0">
            ...
            <p class="mt-4">
              <a class="btn btn-secondary" href="https://www.froala.com"
                >Download</a
              >
              <a class="btn btn-dark ml-3" href="https://www.froala.com"
                >Register</a
              >
            </p>
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-7 col-lg-5 ml-md-auto">
            ...
            <p class="mt-5">
              <img
                ...
                height="25"
                class="mr-4"
                src="imgs/customers/samsung.svg"
              />
              <img
                alt="image"
                height="25"
                class="mr-4"
                src="imgs/customers/adobe.svg"
              />
          ...
          <div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pt-5 pt-md-0">
            <img
              alt="image"
              class="img-fluid rounded-0"
              src="imgs/draws/customer-survey.svg"
            />
          </div>
        </div>
      </div>
    ...
    <section class="fdb-block">
      <div
        class="col-fill-left"
        style="background-image: url(imgs/people/5.jpg);"
      ></div>
    ...
    <section class="fdb-block">
      <div
        ...
        style="background-image: url(imgs/people/6.jpg);"
      ></div>
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-12 col-md-5 text-center">
            ...
            <p>Follow us on</p>
            <p>
              <a href="https://www.froala.com" class="mx-2 text-secondary"
    ...
    <section class="fdb-block bg-dark">
      <div class="container">
        <div class="row text-center">
          <div class="col-12">
            <h1>
              Made with <i class="fas fa-heart text-danger"></i> by Froala
            </h1>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          <div class="col-6 col-lg-3">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/photos/fireworks-1.jpg"
            />
          </div>
          ...
          <div class="col-6 col-lg-3">
            <img
              alt="image"
              class="img-fluid"
              src="imgs/photos/fireworks-2.jpg"
            />
          </div>
      ...
      <div class="container">
        <div class="row text-left align-items-center">
          ...
          <div class="col-12 col-md-6 col-lg-4 pt-4 pt-md-0">
            ...
            <p class="lead">
              Right at the coast of the Semantics, a large language ocean. A
              small river named Dude a rge language ocean there live the blind.
            </p>
            <p class="lead"><a href="https://www.froala.com">Read More</a></p>
          </div>
        ...
        <div class="row text-left justify-content-end">
          <div class="col-12 col-md-6 col-xl-5">
            <div class="fdb-box rounded-bottom-0">
              ...
              <p class="lead mt-4">
                <a class="btn btn-outline-primary" href="https://www.froala.com"
                  >Read More</a
                >
              </p>
            </div>
