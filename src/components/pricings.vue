<template>
  <div>
    ...
    <section class="fdb-block" style="background-image: url(imgs/shapes/1.svg)">
      <div class="container">
        ...
        <div class="row mt-5 align-items-center">
          <div
            class="col-12 col-sm-10 col-md-8 col-md-8 m-auto col-lg-4 text-center"
          >
          ...
          <div
            class="col-12 col-sm-10 col-md-8 col-md-8 m-auto col-lg-4 text-center pt-4 pt-lg-0"
          >
            <div class="fdb-box shadow pb-5 pt-5 pl-3 pr-3 fdb-touch rounded">
              ...
              <p>
                <a href="https://www.froala.com" class="btn btn-primary mt-4"
                  >Subscribe</a
                >
              </p>
            </div>
    ...
    <section class="fdb-block">
      <div class="container">
        ...
        <div class="row mt-5 align-items-center">
          ...
          <div
            class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left pt-4 pt-lg-0"
          >
            <div class="fdb-box fdb-touch p-5 rounded">
              <h2>
                Advanced
        ...
        <div class="row mt-5 align-items-center">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center">
            <div class="fdb-box p-4">
              ...
              <p>
                <a href="https://www.froala.com" class="btn btn-dark"
                  >Buy Now</a
                >
              </p>
            </div>
          ...
          <div
            class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center pt-4 pt-lg-0"
          >
            <div class="fdb-box px-4 pt-5">
              ...
              <p>
                <a href="https://www.froala.com" class="btn btn-secondary"
                  >Buy Now</a
                >
              </p>
            </div>
    ...
    <section class="fdb-block py-0">
      <div
        class="container pt-5 my-5"
        style="background-image: url(imgs/shapes/2.svg)"
      >
    ...
    >
      <div class="container">
        ...
        <div class="row mt-5 align-items-center no-gutters">
          <div
            class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center shadow"
          >
            <div class="bg-white pb-5 pt-5 pl-4 pr-4 rounded-left">
              ...
              <p class="text-center pt-4">
                <a href="https://www.froala.com" class="btn btn-outline-dark"
                  >Choose Plan</a
                >
              </p>
            </div>
          ...
          <div
            class="col-12 col-sm-10 col-md-8 ml-auto mr-auto col-lg-4 text-center mt-4 mt-lg-0 sl-1 pt-0 pt-lg-3 pb-0 pb-lg-3 bg-white fdb-touch rounded shadow"
          >
          ...
          <div
            class="col-12 col-sm-10 col-md-8 ml-auto mr-auto col-lg-4 text-center mt-4 mt-lg-0 shadow"
          >
        ...
        <div class="row mt-5 align-items-top">
          <div class="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-left">
            <div class="rounded">
              ...
              <div class="bg-gray p-5 text-center">
                ...
                <p class="h4">
                  <strong>For small companies</strong>
                </p>
                <p>
                  <br />
                </p>
          ...
          >
            <div class="rounded">
              ...
              <div class="bg-gray p-5 text-center">
                <p>
                  <img alt="image" height="40" src="imgs/icons/monitor.svg" />
                </p>
                <p class="h4">
                  <strong>For medium companies</strong>
                </p>
                <p>
                  <br />
                </p>
          ...
          >
            <div class="rounded">
              ...
              <div class="bg-gray p-5 text-center">
                <p>
                  <img alt="image" height="40" src="imgs/icons/package.svg" />
                </p>
                <p class="h4">
                  <strong>For large companies</strong>
                </p>
                <p>
                  <br />
                </p>
    ...
    <section class="fdb-block">
      <div class="container">
        ...
        <div class="row mt-5 align-items-top">
          <div
            class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left"
          >
          ...
          <div
            class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-md-0"
          >
            <div class="bg-gray p-3 text-center rounded sl-1">
          ...
          <div
            class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-xl-0"
          >
            <div class="bg-gray p-3 text-center rounded sl-1">
              <h2 class="font-weight-light">Business</h2>
              <p class="h2">$999</p>
